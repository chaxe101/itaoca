...
export const metadata: Metadata = {
  title: "Mensagens | Proprietário | VrumGo",
  description: "Gerencie suas mensagens com locatários",
}

export default function OwnerMensagensPage() {
  ...
  const conversations = [
    {
      ...
      lastMessage: "Olá, gostaria de saber se o carro está disponível para o próximo final de semana?",
      time: "10:30",
      unread: true,
    },
    {
      ...
      name: "Ana Pereira",
      avatar: "/placeholder.svg?height=40&width=40",
      lastMessage: "Obrigada pela confirmação! Vou fazer a reserva agora.",
      time: "Ontem",
      unread: false,
    },
    {
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      lastMessage: "O carro estava em perfeitas condições. Muito obrigado!",
      time: "Seg",
      unread: false,
    },
    {
      ...
      name: "Juliana Costa",
      avatar: "/placeholder.svg?height=40&width=40",
      lastMessage: "Posso pegar o carro uma hora antes do combinado?",
      time: "Seg",
      unread: true,
    },
  ]
  ...
  const activeConversation = {
    ...
    messages: [
      ...
      },
      {
        id: 2,
        sender: "me",
        content: "Olá Carlos! Sim, o carro está disponível. Quais datas você está interessado?",
        time: "10:35",
      },
      {
        id: 3,
      ...
      },
      {
        id: 4,
        sender: "me",
        content: "Perfeito! Essas datas estão disponíveis. Você pode fazer a reserva pelo sistema.",
        time: "10:45",
      },
      {
        id: 5,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1">
          <CardHeader>
            ...
            <CardDescription>Gerencie suas conversas com locatários</CardDescription>
          </CardHeader>
          <CardContent>
